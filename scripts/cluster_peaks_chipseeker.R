...
# ADD PEAK KEYS FOR PLEKHG1 AND OPC - NEEDED FOR MOFA WEIGHT ANNOTATION (forgot these before)
...
#can proceed with mofa after running chipseeker annotations, GO can be done after mofa. MOVE ONTO MOFA. 
...
#GO ENRICHMENT , issues with this, need to look over
