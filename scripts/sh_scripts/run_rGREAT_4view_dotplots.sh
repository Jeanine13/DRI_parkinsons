#!/bin/bash
#SBATCH --job-name=rGREAT_4view_dotplots
#SBATCH --output=/scratch/prj/bcn_marzi_lab/analysis_cutandtag_pd_sc/student_data_package/jd_analysis_sc/logs/rGREAT_4view_dotplots_%j.out
#SBATCH --error=/scratch/prj/bcn_marzi_lab/analysis_cutandtag_pd_sc/student_data_package/jd_analysis_sc/logs/rGREAT_4view_dotplots_%j.err
